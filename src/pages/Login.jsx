  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const msgs = {
        ...
        'auth/unauthorized-domain': 'Domínio não autorizado no Firebase. Adicione leafaroinafipe.github.io em Authentication → Settings → Authorized domains.',
        'auth/invalid-api-key':     'Chave de API inválida. Verifique o arquivo .env.',
        'auth/network-request-failed': 'Sem conexão com o Firebase. Verifique sua internet.',
      };
      setError(msgs[err.code] || `Erro: ${err.code}`);
    } finally {
      setLoading(false);
    }
  }
